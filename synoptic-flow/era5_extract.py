...
for idxs in groups.values():
    ...
    udlm = np.trapz(uenv.data * pressure[None, :, None, None], pressure, axis=1) / np.trapz(pressure, pressure)
    uout[out_idxs] = udlm
    ...
    vdlm = np.trapz(venv.data * pressure[None, :, None, None], pressure, axis=1) / np.trapz(pressure, pressure)
    vout[out_idxs] = vdlm
